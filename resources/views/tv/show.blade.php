...
@section('content')
    <div class="movie-info border-b border-white">
        <div class="mx-auto px-4 py-16 flex flex-col md:flex-row" style="background-image: linear-gradient(to right, rgba(10.98%, 11.76%, 12.55%, 1.00) 150px, rgba(10.98%, 11.76%, 12.55%, 0.84) 100%), url(https://www.themoviedb.org/t/p/w1920_and_h800_multi_faces{{ $tvshow['backdrop_path'] }})">
            <div class="flex-none">
                <img src="{{ $tvshow['poster_path'] }}" alt="poster" class="w-64 lg:w-96">
            </div>
            <div class="md:ml-24">
                <h2 class="text-4xl mt-4 md:mt-0 text-white font-semibold">{{ $tvshow['name'] }}</h2>
    ...
    <div class="movie-cast border-b border-white">
        <div class="container text-white mx-auto px-4 py-16">
            <h2 class="uppercase tracking-wider p-2 text-black bg-white text-center rounded-full text-2xl font-semibold">Cast</h2>
    ...
    <div class="movie-images" x-data="{ isOpen: false, image: ''}">
        <div class="container mx-auto px-4 py-16">
            <h2 class="uppercase tracking-wider p-2 text-black bg-white text-center rounded-full text-2xl font-semibold">Images</h2>
