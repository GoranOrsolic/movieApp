...
<body class="font-sans text-black bg-black">
<nav class="border-b border-white text-white">
    <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
        <ul class="flex flex-col md:flex-row items-center">
            <li>
                <a href="{{ route('index') }}">
                    <img src="{{ asset('/img/imga.png') }}" style="width: 150px; height: 50px;" alt="">
...
{{--                    </svg>--}}
            ...
            <li class="z-50 dropdown md:ml-16 mt-3 md:mt-0">
                <a class="hover:opacity-75 cursor-pointer">Movies</a>
                <div class="dropdown-menu absolute hidden h-auto flex">
                    <ul class="block rounded-md bg-black p-6">
                        <li class="py-1"><a href="{{ route('movies.index') }}" class="block text-white hover:opacity-75 cursor-pointer">Popular Movies</a></li>
                        <li class="py-1"><a href="{{ route('movies.nowPlay') }}" class="block text-white hover:opacity-75 cursor-pointer">Now Playing</a></li>
                    </ul>
                </div>
            </li>
            <li class="z-30 dropdown md:ml-6 mt-3 md:mt-0">
                <a class="hover:opacity-75 cursor-pointer">TV Shows</a>
                <div class="dropdown-menu absolute hidden h-auto flex">
                    <ul class="block rounded-md bg-black p-6">
                        <li class="py-1"><a href="{{ route('tv.index') }}" class="block text-white hover:opacity-75 cursor-pointer">Popular TV Shows</a></li>
                        <li class="py-1"><a href="{{ route('tv.TopRatedTV') }}" class="block text-white hover:opacity-75 cursor-pointer">Top Rated TV Shows</a></li>
                    </ul>
                </div>
            </li>
            <li class="md:ml-6 mt-3 md:mt-0">
                <a href="{{ route('actors.index') }}" class="hover:opacity-75">Actors</a>
            </li>
        </ul>
